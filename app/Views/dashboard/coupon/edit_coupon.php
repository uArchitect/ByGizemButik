                ...
                <form action="<?= base_url('edit-coupon-post'); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative">
                            <input type="text" name="coupon_code" id="input_coupon_code" value="<?= esc($coupon->coupon_code); ?>" class="form-control form-input" placeholder="<?= "Kupon Kodu"; ?>" maxlength="49" required>
                    ...
                    <div class="form-group">
                        ...
                        <?= formRadio('is_public', 1, 0, "Evet", "Hayır", $coupon->is_public, 'col-lg-4'); ?>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12 max-600">
                                ...
                                <div class='input-group date' id='datetimepicker'>
                                    <input type='text' class="form-control" name="expiry_date" value="<?= esc($coupon->expiry_date); ?>" placeholder="<?= "Son Kullanma Tarihi"; ?>" required>

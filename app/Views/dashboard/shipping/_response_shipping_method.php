        ...
        <div class="col-sm-12">
            ...
            <?php if ($selectedOption == 'flat_rate'): ?>
                <div class="response-shipping-method">
                    <span class="title"><?= $selectedOption; ?></span>
                                ...
                                <div class="modal-body">
                                    <div class="form-group m-b-10">
                                        ...
                                        <?php foreach ($activeLanguages as $language): ?>
                                            <input type="text" name="method_name_<?= $optionUniqueId; ?>_lang_<?= $language->id; ?>" class="form-control form-input m-b-5" value="<?= $selectedOption; ?>" placeholder="<?= esc($language->name); ?>" maxlength="255">
                                        <?php endforeach; ?>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="flat_rate_cost_calculation_type_<?= $optionUniqueId; ?>" class="form-control custom-select">
                                            <option value="each_product"><?= "Her ürün için kargo ücreti al"; ?></option>
                                            <option value="each_different_product"><?= "Her farklı ürün için kargo ücreti al"; ?></option>
                                            <option value="cart_total"><?= "Sepet toplamı için sabit kargo ücreti"; ?></option>
                                        </select>
                                    </div>
                                    <div class="form-group m-b-10">
                    ...
                    <div class="btn-group btn-group-option">
                        ...
                        <a href="javascript:void(0)" class="btn btn-sm btn-default btn-delete-shipping-method" data-toggle="tooltip" title="<?= "Sil"; ?>"  data-id="<?= $optionUniqueId; ?>"><i class="fa fa-trash-o"></i></a>
                    </div>
                </div>

            ...
            <?php if ($selectedOption == 'flat_rate'): ?>
                <div class="response-shipping-method">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"><?= $selectedOption; ?></h4>
                                </div>
                                <div class="modal-body">
                                    <div class="form-group m-b-10">
                                        <label class="control-label"><?= "Yöntem Adı"; ?></label>
                                    ...
                                    <div class="form-group">
                                        <label><?= "Maliyet hesaplama tipi"; ?></label>
                                        <select name="flat_rate_cost_calculation_type_<?= $optionUniqueId; ?>" class="form-control custom-select">
                                            <option value="each_product" <?= $method->flat_rate_cost_calculation_type == 'each_product' ? 'selected' : ''; ?>><?= "Her ürün için kargo ücreti al"; ?></option>
                                            <option value="each_different_product" <?= $method->flat_rate_cost_calculation_type == 'each_different_product' ? 'selected' : ''; ?>><?= "Her farklı ürün için kargo ücreti al"; ?></option>
                                            <option value="cart_total" <?= $method->flat_rate_cost_calculation_type == 'cart_total' ? 'selected' : ''; ?>><?= "Sepet toplamı için sabit kargo ücreti"; ?></option>
                                        </select>
                                    </div>
                                    <div class="form-group m-b-10">
                                    ...
                                    <?php if (!empty($shippingClasses)): ?>
                                        <div class="form-group">
                                            <label><?= "Kargo sınıfı maliyetleri"; ?></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    <label for="status_<?= $optionUniqueId; ?>_1" class="custom-control-label"><?= "Etkin"; ?></label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    <label for="status_<?= $optionUniqueId; ?>_2" class="custom-control-label"><?= "Devre Dışı"; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="btn-group btn-group-option">
                        <a href="javascript:void(0)" class="btn btn-sm btn-default btn-edit" data-toggle="modal" data-target="#modalMethod<?= $optionUniqueId; ?>"><span data-toggle="tooltip" title="<?= "Düzenle"; ?>"><i class="fa fa-edit"></i></span></a>
                        <a href="javascript:void(0)" class="btn btn-sm btn-default" data-toggle="tooltip" title="<?= "Sil"; ?>" onclick='deleteShippingMethod("<?= $optionUniqueId; ?>","<?= "Bu kaydı silmek istediğinizden emin misiniz?"; ?>");'><i class="fa fa-trash-o"></i></a>
                    </div>
                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group m-b-10">
                                        <label class="control-label"><?= "Minimum Sipariş Tutarı"; ?></label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><?= $defaultCurrency->symbol; ?></span>

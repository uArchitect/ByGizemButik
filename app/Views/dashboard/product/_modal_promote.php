    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= "Ürününüzü Tanıtın"; ?></h4>
            </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <div id="pricingPlan_1" class="price-box">
                            <div class="pricing-name text-center">
                                <h4 class="name"><?= "Günlük Plan"; ?></h4>
                            </div>
                            <div class="plan-price text-center">
                                <?php if ($paymentSettings->free_product_promotion == 1): ?>
                                    <h3><span class="price"><?= priceFormatted(0, $defaultCurrency->code); ?></span><span class="time">/<?= "Gün"; ?></span></h3>
                                <?php else: ?>
                                    <h3><span class="price"><?= priceFormatted($paymentSettings->price_per_day, $defaultCurrency->code); ?></span><span class="time">/<?= "Gün"; ?></span></h3>
                                <?php endif; ?>
                            </div>
                            <div class="price-features">
                                ...
                                <p>
                                    ...
                                    <?= "Arama listelerinde önce göster"; ?>
                                </p>
                            </div>
                            <div class="text-center">
                                <a href="javascript:void(0)" class="btn btn-md btn-pricing-table" data-pricing-plan="pricingPlan_1"><?= "Planı Seç"; ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <div id="pricingPlan_2" class="price-box">
                            <div class="pricing-name text-center">
                                <h4 class="name"><?= "Aylık Plan"; ?></h4>
                            </div>
                            <div class="plan-price text-center">
                                <?php if ($paymentSettings->free_product_promotion == 1): ?>
                                    <h3><span class="price"><?= priceFormatted(0, $defaultCurrency->code); ?></span><span class="time">/<?= "Ay"; ?></span></h3>
                                <?php else: ?>
                                    <h3><span class="price"><?= priceFormatted($paymentSettings->price_per_month, $defaultCurrency->code); ?></span><span class="time">/<?= "Ay"; ?></span></h3>
                                <?php endif; ?>
                            </div>
                            <div class="price-features">
                                <p>
                            ...
                            <div class="text-center">
                                <a href="javascript:void(0)" class="btn btn-md btn-pricing-table" data-pricing-plan="pricingPlan_2"><?= "Planı Seç"; ?></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <?php if ($paymentSettings->free_product_promotion != 1): ?>
                                <div class="form-group">
                                    <?php if ($defaultCurrency->symbol_direction == 'left'): ?>
                                        <strong class="price-total"><?= "Toplam Tutar"; ?>&nbsp;<?= $defaultCurrency->symbol; ?><span class="span-price-total-daily"><?= $pricePerDay; ?></span>&nbsp;<?= $defaultCurrency->code; ?></strong>
                                    <?php else: ?>
                                        <strong class="price-total"><?= "Toplam Tutar"; ?>&nbsp;<span class="span-price-total-daily"><?= $pricePerDay; ?></span><?= $defaultCurrency->symbol; ?>&nbsp;<?= $defaultCurrency->code; ?></strong>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group m-0">
                                    <button type="submit" class="btn btn-lg btn-success"><?= "Ödemeye Devam Et"; ?></button>
                                </div>
                            <?php else: ?>
                                <div class="form-group m-0">
                                    <button type="submit" class="btn btn-lg btn-success"><?= "Gönder"; ?></button>
                                </div>
                            <?php endif; ?>
                        </form>
                    </div>
                    ...
                    <div class="col-sm-12 container-pricing-plan" id="container_pricingPlan_2">
                        <form action="<?= base_url('promote-product-post'); ?>" method="post" onkeypress="return event.keyCode != 13;">
                            ...
                            <?php if ($paymentSettings->free_product_promotion != 1): ?>
                                <div class="form-group">
                                    <?php if ($defaultCurrency->symbol_direction == "left"): ?>
                                        <strong class="price-total"><?= "Toplam Tutar"; ?>&nbsp;<?= $defaultCurrency->symbol; ?><span class="span-price-total-monthly"><?= $pricePerMonth; ?></span>&nbsp;<?= $defaultCurrency->code; ?></strong>
                                    <?php else: ?>
                                        <strong class="price-total"><?= "Toplam Tutar"; ?>&nbsp;<span class="span-price-total-monthly"><?= $pricePerMonth; ?></span><?= $defaultCurrency->symbol; ?>&nbsp;<?= $defaultCurrency->code; ?></strong>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group m-0">
                                    <button type="submit" class="btn btn-lg btn-success"><?= "Ödemeye Devam Et"; ?></button>

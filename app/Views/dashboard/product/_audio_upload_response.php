                        ...
                        <ul class="dm-uploaded-files dm-uploaded-media-file">
                            <li class="media li-dm-media-preview">
                                <div class="audio-player audio-player-preview w-100">
                                    <a href="javascript:void(0)" class="btn-img-delete btn-video-delete position-relative float-right m-l-5" onclick="deleteProductAudioPreview('<?= $product->id; ?>','<?= "Ürün sesini onayla" ?>');">
            ...
            <?php else: ?>
                <div class="dm-uploader-container">
                    <div id="drag-and-drop-zone-audio" class="dm-uploader dm-uploader-media text-center">
                        ...
                        <p class="dm-upload-text"><?= "Dosyayı buraya sürükleyip bırakın"; ?>&nbsp;<span style="text-decoration: underline"><?= "Dosyalara Göz At"; ?></span></p>

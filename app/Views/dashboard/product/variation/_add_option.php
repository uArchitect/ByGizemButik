<form id="form_add_product_variation_option" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="custom-control custom-radio">
                                    ...
                                    <label for="is_default_1" class="custom-control-label"><?= "Evet"; ?></label>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="custom-control custom-radio">
                                    <input type="radio" name="is_default" value="0" id="is_default_2" class="custom-control-input" checked>
                                    <label for="is_default_2" class="custom-control-label"><?= "Hayır"; ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php if (!empty($activeLanguages)):
                        ...
                        <?php else:
                            foreach ($activeLanguages as $language):
                                ...
                                <?php else: ?>
                                    <input type="text" class="form-control form-input input-variation-option" name="option_name_<?= $language->id; ?>" placeholder="<?= esc($language->name) . ' (' . "İsteğe Bağlı" . ')'; ?>" maxlength="255">
                                <?php endif;
                            endforeach;
                        endif;
                    endif; ?>
                        ...
                        <?php if ($variation->variation_type != 'dropdown' && $variation->option_display_type == 'color'): ?>
                            <div class="col-sm-6">
                                ...
                                <div class="input-group colorpicker">
                                    <input type="text" class="form-control" name="option_color" maxlength="200" placeholder="<?= "Renk"; ?>">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-sm-12">
                                        ...
                                        <div id="discount_input_container_variation">
                                            <div class="input-group">
                                                <span class="input-group-addon"><?= $defaultCurrency->symbol; ?></span>
                                                <input type="text" name="price_discounted" id="variation_discounted_price_input" class="form-control form-input price-input m-0" placeholder="<?= $baseVars->inputInitialPrice; ?>" onpaste="return false;" maxlength="32">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 m-t-10">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="checkbox_has_discount" id="checkbox_discount_rate_variation">
                                                        ...
                                                        foreach ($variationImagesSession as $imgSession):?>
                                                            <li class="media" id="uploaderFile<?= $imgSession->file_id; ?>">
                                                                ...
                                                                <?php if ($imgSession->is_main == 1): ?>
                                                                    <a href="javascript:void(0)" class="btn btn-xs btn-success btn-is-image-main btn-set-variation-image-main-session"><?= "Ana"; ?></a>
                                                                <?php else: ?>
                                                                    <a href="javascript:void(0)" class="btn btn-xs btn-secondary btn-is-image-main btn-set-variation-image-main-session" data-file-id="<?= $imgSession->file_id; ?>"><?= "Ana"; ?></a>
                                                                <?php endif; ?>
                                                            </li>
                                                        <?php endforeach;
                                                    endif; ?>
    ...
    <div class="modal-footer">
        <div class="row-custom">
            <button type="button" id="btn_add_variation_option" class="btn btn-md btn-success color-white float-right"><?= "Seçenek Ekle"; ?></button>
        </div>
    </div>
</form>
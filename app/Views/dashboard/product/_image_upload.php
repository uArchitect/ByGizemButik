                ...
                foreach ($images as $image):
                    ...
                    <li class="media" id="uploaderFile<?= $image->file_id; ?>">
                        ...
                        <?php if ($image->is_main == 1): ?>
                            <a href="javascript:void(0)" class="btn btn-xs btn-success btn-is-image-main btn-set-image-main-session"><?= "Ana"; ?></a>
                        <?php else: ?>
                            <a href="javascript:void(0)" class="btn btn-xs btn-secondary btn-is-image-main btn-set-image-main-session" data-file-id="<?= $image->file_id; ?>"><?= "Ana"; ?></a>
                        <?php endif; ?>
                    </li>
                <?php endforeach;
            endif; ?>
...
<div class="row-custom">
    <p class="images-exp"><i class="icon-exclamation-circle"></i><?= "Uyarı: Ürün ana resmi"; ?></p>
</div>

    ...
    if (!empty($digitalFile)):?>
        <form action="<?= base_url('download-digital-file-post'); ?>" method="post" id="form_download_digital_file">
            ...
            <div class="dm-uploaded-digital-file">
                ...
                <a href="javascript:void(0)" class="btn btn-sm btn-danger pull-right" onclick="deleteProductDigitalFile('<?= $digitalFile->id; ?>','<?= "Bu kaydı silmek istediğinizden emin misiniz?" ?>');">

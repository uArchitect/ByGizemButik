                                            ...
                                            <li class="media">
                                                ...
                                                <div class="media-body refund-media-body text-right">
                                                    <div class="form-group">
                                                        <textarea name="message" class="form-control form-textarea" placeholder="<?= "Mesaj"; ?>..." required></textarea>
                                                    </div>
                                                    <div class="form-group">
                                ...
                                if ($refundRequest->status == 0): ?>
                                    <div class="col-sm-12 text-center">
                                        <form action="<?= base_url('Dashboard/approveDeclineRefund'); ?>" method="post">
                                            <?= csrf_field(); ?>
                                            <input type="hidden" name="id" value="<?= $refundRequest->id; ?>">
                                            <button type="submit" name="submit" value="1" class="btn btn-lg btn-success"><i class="fa fa-check"></i>&nbsp;&nbsp;<?= "İadeyi Onayla"; ?></button>
                                            <button type="submit" name="submit" value="0" class="btn btn-lg btn-danger"><i class="fa fa-ban"></i>&nbsp;&nbsp;<?= "Reddet"; ?></button>
                                        </form>
                                    </div>
                                <?php endif; ?>
                            </div>

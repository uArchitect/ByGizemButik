                ...
                <div class="form-add-product">
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-12">
                            <div class="row">
                                <div class="col-12">
                                    <p class="start-selling-description text-muted"><?= "Planınızı seçin açıklaması"; ?></p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                                    ...
                                                    <div class="price-box">
                                                        ...
                                                        <div class="price-box-inner">
                                                            ...
                                                            <div class="text-center btn-plan-pricing-container">
                                                                <?php if ($validPlan == 1): ?>
                                                                    <button type="submit" name="plan_id" value="<?= $plan->id; ?>" class="btn btn-md btn-custom"><?= "Plan Seç"; ?></button>
                                                                <?php else: ?>
                                                                    <button type="button" class="btn btn-md btn-custom btn-pricing-table-disabled"><?= "Plan Seç"; ?></button>
                                                                    <?php if ($plan->is_free == 1 && user()->is_used_free_plan == 1): ?>
                                                                        <span class="warning-pricing-table-plan text-muted"><?= "Plan kullanıldı uyarısı"; ?></span>
                                                                    <?php else: ?>
                                                                        <span class="warning-pricing-table-plan text-muted"><?= "Plan seçilemez uyarısı"; ?></span>
                                                                    <?php endif;
                                                                endif; ?>
                                                            </div>
                                                        </div>

...
<div class="product-audio-preview">
    ...
    <div class="player-control-container">
        <button class="btn btn-secondary btn-backward" onclick="skipBackward();"><i class="icon-backward m-r-5"></i><?= "Geri"; ?></button>
        <button class="btn btn-secondary btn-play-pause amplitude-play-pause"><i class="icon-play m-r-5"></i><?= "Oynat"; ?>&nbsp;/&nbsp;<i class="icon-pause m-r-5"></i><?= "Duraklat"; ?></button>
        <button class="btn btn-secondary btn-forward" onclick="skipForward();"><i class="icon-forward m-r-5"></i><?= "İleri"; ?></button>
    </div>
</div>

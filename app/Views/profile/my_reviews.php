                    ...
                    <div class="col-12">
                        <nav class="nav-breadcrumb" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?= "Takipçiler"; ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="reviews-container">
                                <div class="col-12">
                                    <div class="review-total">
                                        <label class="label-review"><?= "Yorumlarım"; ?>&nbsp;(<?= numberFormatShort($numRows); ?>)</label>
                                    </div>
                                            ...
                                            <?php foreach ($reviews as $review): ?>
                                                <li class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        if (!empty($reviewProduct)):?>
                                                            <div class="row-custom m-b-10">
                                                                <a href="<?= generateProductUrlBySlug($reviewProduct->slug); ?>"><strong><?= "Ürün"; ?>:&nbsp;</strong><?= getProductTitle($reviewProduct); ?></a>
                                                            </div>
                                                        <?php endif; ?>
                                                    ...
                                                    <?php if (authCheck() && user()->id == $user->id): ?>
                                                        <button type="button" class="button-link text-muted link-abuse-report" onclick="deleteReview('<?= $review->id; ?>','<?= clrDoubleQuotes("Yorumu onayla"); ?>');"><?= "Sil"; ?></button>
                                                    <?php endif; ?>
                                                </li>
                                            <?php endforeach; ?>
                                        </ul>

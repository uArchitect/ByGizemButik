                        ...
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    <p class="font-weight-bold mb-1"><span style="display: inline-block;width: 100px;"><?= "Fatura"; ?>:</span>#INVD<?= $transaction->id; ?></p>
                        ...
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    ...
                                    <p class="mb-1"><span style="display: inline-block;min-width: 158px;"><?= "Ödeme Durumu"; ?>:</span><?= $transaction->payment_status == 1 ? "Ödeme Alındı" : "Ödeme Bekleniyor"; ?></p>

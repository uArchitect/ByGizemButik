                        ...
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    <p class="font-weight-bold mb-1"><span style="display: inline-block;width: 100px;"><?= "Fatura"; ?>:</span>#INVM<?= $transaction->id; ?></p>
                                    <p class="font-weight-bold"><span style="display: inline-block;width: 100px;"><?= "Tarih"; ?>:</span><?= formatDate($transaction->created_at); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="padding: 45px 30px;">
                            <div class="col-6">
                                ...
                                if (!empty($user->tax_registration_number)): ?>
                                    <p class="mb-1"><?= "Vergi Sicil Numarası"; ?>:&nbsp;<?= esc($user->tax_registration_number); ?></p>
                                <?php endif; ?>
                            </div>
                            <div class="col-6">
                                <div class="float-right">
                                    <p class="font-weight-bold mb-3"><?= "Ödeme Detayları"; ?></p>
                                    <p class="mb-1"><span style="display: inline-block;min-width: 158px;"><?= "Ödeme Durumu"; ?>:</span><?= $transaction->payment_status == 'awaiting_payment' ? "Ödeme Bekleniyor" : "Ödeme Alındı"; ?></p>
                                    <p class="mb-1"><span style="display: inline-block;min-width: 158px;"><?= "Ödeme Yöntemi"; ?>:</span><?= getPaymentMethod($transaction->payment_method); ?></p>
                                    <p class="mb-1"><span style="display: inline-block;min-width: 158px;"><?= "Para Birimi"; ?>:</span><?= $transaction->currency; ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="row p-4">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="border-0 font-weight-bold"><?= "Üyelik Planı"; ?></th>
                                            <th class="border-0 font-weight-bold"><?= "Toplam"; ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr style="font-size: 15px;">
                                            <td><?= "Üyelik planı ödemesi"; ?></td>

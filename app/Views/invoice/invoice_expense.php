                        ...
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    <p class="font-weight-bold mb-1"><span style="display: inline-block;width: 100px;"><?= "Fatura"; ?>:</span>#INVE<?= $transaction->id; ?></p>
                        ...
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    ...
                                    <p class="mb-1"><span style="display: inline-block;min-width: 158px;"><?= "Ödeme Durumu"; ?>:</span><?= "Ödeme Alındı"; ?></p>
                                    <p class="mb-1"><span style="display: inline-block;min-width: 158px;"><?= "Ödeme Yöntemi"; ?>:</span><?= "Cüzdan Bakiyesi"; ?></p>

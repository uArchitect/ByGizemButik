                        ...
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    <p class="font-weight-bold mb-1"><span style="display: inline-block;width: 100px;"><?= "Fatura"; ?>:</span>#INVP<?= $transaction->id; ?></p>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="border-0 font-weight-bold"><?= "Satın Alınan Plan"; ?></th>

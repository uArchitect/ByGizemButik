                    ...
                    <div class="sidebar-tabs-content">
                        ...
                        <form action="<?= base_url('edit-profile-post'); ?>" method="post" id="form_validate" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <p class="mb-4"><small class="text-muted">*<?= "Profil resmi düzenleme uyarısı"; ?></small></p>
                            </div>
                            <div class="form-group">
                                <label class="control-label">
                                    ...
                                    <?php if ($generalSettings->email_verification == 1): ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <a href="javascript:void(0)" class="color-link link-underlined font-weight-normal" onclick="sendActivationEmail('<?= user()->token; ?>', 'profile');"><?= "Doğrulama e-postasını tekrar gönder"; ?></a>
                                            <div class="display-inline-block font-weight-normal m-l-5" id="confirmation-result-profile"></div>
                                        <?php endif;
                                    endif; ?>
                                </label>
                                <input type="email" name="email" class="form-control form-input" value="<?= esc(user()->email); ?>" placeholder="<?= "E-posta Adresi"; ?>" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label"><?= "Slug"; ?></label>
                                <input type="text" name="slug" class="form-control form-input" value="<?= esc(user()->slug); ?>" placeholder="<?= "Slug"; ?>" maxlength="200" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label"><?= "Ad"; ?></label>
                                <input type="text" name="first_name" class="form-control form-input" value="<?= esc(user()->first_name); ?>" placeholder="<?= "Ad"; ?>" maxlength="250" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label"><?= "Soyad"; ?></label>
                                <input type="text" name="last_name" class="form-control form-input" value="<?= esc(user()->last_name); ?>" placeholder="<?= "Soyad"; ?>" maxlength="250" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label"><?= "Telefon Numarası"; ?></label>
                                <input type="text" name="phone_number" class="form-control form-input" value="<?= esc(user()->phone_number); ?>" placeholder="<?= "Telefon Numarası"; ?>" maxlength="100">
                            </div>
                            <div class="form-group">
                                <label class="control-label"><?= "Vergi Sicil Numarası"; ?></label>
                                <input type="text" name="tax_registration_number" class="form-control form-input" value="<?= esc(user()->tax_registration_number); ?>" placeholder="<?= "Vergi Sicil Numarası"; ?>" maxlength="255">
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12">
                                        <label class="control-label"><?= "Kapak resmi tipi"; ?></label>
                                    </div>
                                    <div class="col-md-3 col-sm-4 col-12">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="cover_image_type_1" class="custom-control-label"><?= "Tam Genişlik"; ?></label>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-4 col-12">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="cover_image_type_2" class="custom-control-label"><?= "Kutulu"; ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label for="send_email_new_message" class="custom-control-label"><?= "E-posta seçeneği yeni mesaj e-postası gönder"; ?></label>
                                </div>
                            </div>
                            <?php if ($generalSettings->show_vendor_contact_information == 1): ?>
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label for="checkbox_show_email" class="custom-control-label"><?= "E-postamı göster"; ?></label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="show_phone" value="1" id="checkbox_show_phone" class="custom-control-input" <?= user()->show_phone == 1 ? 'checked' : ''; ?>>
                                        <label for="checkbox_show_phone" class="custom-control-label"><?= "Telefonumu göster"; ?></label>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <button type="submit" name="submit" value="update" class="btn btn-md btn-custom m-t-10"><?= "Değişiklikleri Kaydet" ?></button>
                        </form>
                    </div>
                </div>
            </div>

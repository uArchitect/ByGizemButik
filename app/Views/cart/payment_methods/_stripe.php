        ...
        <div class="col-12 col-lg-10 stripe-checkout">
            <form id="payment-form">
                ...
                <div class="form-group">
                    <input type="text" name="name" id="sp_input_name" class="form-control shadow-sm" placeholder="<?= "Tam Ad"; ?>">
                </div>
                <div class="form-group">
                    <input type="email" name="email" id="sp_input_email" class="form-control shadow-sm" placeholder="<?= "E-posta"; ?>">
                </div>
                <div class="form-group">
                ...
                <button id="submit" class="btn btn-primary" id="card-button">
                    ...
                    <?= "Öde"; ?>&nbsp;<?= priceFormatted($totalAmount, $currency); ?>
                </button>
            </form>
        </div>
    </div>

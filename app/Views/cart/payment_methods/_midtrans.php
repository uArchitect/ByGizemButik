<?php if (!empty($paymentGateway) && $paymentGateway->name_key == 'midtrans'):
    ...
    if ($showMidtrans == true):
        ...
        <div id="payment-button-container" class="payment-button-cnt">
            ...
            <p class="p-complete-payment text-muted"><?php echo "Ödemeyi tamamlayın"; ?></p>
            <button type="button" id="pay-button" class="btn btn-lg btn-payment btn-midtrans"><?= "Öde"; ?>&nbsp;<?= priceDecimal($grossAmount, $currency); ?></button>
        </div>

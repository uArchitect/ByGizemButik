<?php if (!empty($paymentGateway) && $paymentGateway->name_key == 'flutterwave'):
    ...
    <form>
        ...
        <div id="payment-button-container" class="payment-button-cnt">
            ...
            <p class="p-complete-payment text-muted"><?= "Ödemeyi tamamlayın"; ?></p>
            <button type="button" onClick="makePayment()" class="btn btn-lg btn-payment btn-flutterwave"><?= "Öde"; ?>&nbsp;<?= priceDecimal($totalAmount, $currency); ?></button>
        </div>
    </form>

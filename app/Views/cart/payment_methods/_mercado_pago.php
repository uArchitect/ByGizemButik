...
if (!empty($paymentGateway) && $paymentGateway->name_key == 'mercado_pago'):
    ...
    <div id="payment-button-container" class="payment-button-cnt">
        ...
        <script src="<?= $mercadoUrl; ?>" data-preference-id="<?= $preference->id; ?>" data-button-label="<?= "Öde"; ?>&nbsp;<?= strip_tags(priceDecimal($totalAmount, $currency) ?? ''); ?>"></script>
    </div>
<?php else: ?>

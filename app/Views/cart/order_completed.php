        ...
        <div class="row">
            <div class="col-12">
                <div class="page-confirm">
                    ...
                    <h1 class="title"><?= "Sipariş tamamlandı mesajı"; ?></h1>
                    <p class="p-order-number"><?= "Sipariş"; ?>:&nbsp;#<?= esc($order->order_number); ?></p>
                    <?php if($order->payment_method == 'Bank Transfer'): ?>
                        <p class="p-complete-payment"><?= "Banka havalesi sipariş tamamlandı metni"; ?></p>

...
<item>
    ...
    <description><![CDATA[<div class="price"><p>✔ <?= "Fiyat" . ': ' . priceFormatted($product->price,$product->currency). ' '; ?></p></div><div class="description"><?= !empty($productDetails) ? $productDetails->description : ''; ?></div>]]></description>
<?php $imagePath = '';
$fileSize = 12;

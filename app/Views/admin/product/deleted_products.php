                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="restoreProduct('<?= $item->id; ?>');"><i class="fa fa-reply option-icon"></i><?= "Geri Yükle"; ?></a>
                                                    </li>
                                                    <li>
                        ...
                        <div class="col-sm-12 table-ft">
                            <div class="row">
                                ...
                                <?php if (count($products) > 0): ?>
                                    <div class="pull-left">
                                        <button class="btn btn-sm btn-danger btn-table-delete" onclick="deleteSelectedProductsPermanently('Seçili ürünleri silmek istediğinizden emin misiniz?');"><?= "Sil"; ?></button>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>

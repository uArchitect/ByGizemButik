                        ...
                        <?php if (!empty($products)):
                            foreach ($products as $item): ?>
                                <tr>
                                    ...
                                    <td><?= $item->product_type == 'physical' ? 'Fiziksel' : ($item->product_type == 'digital' ? 'Dijital' : $item->product_type); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <?php if ($item->is_rejected == 1): ?>
                                            ...
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalReason<?= $item->id; ?>"><i class="fa fa-info-circle"></i>&nbsp;&nbsp;<?= "Sebebi Göster"; ?></button>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu options-dropdown">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)" onclick="approveProduct('<?= $item->id; ?>');"><i class="fa fa-check option-icon"></i><?= "Onayla"; ?></a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#modalReject" onclick="$('#reject_product_id').val(<?= $item->id; ?>);"><i class="fa fa-ban option-icon"></i><?= "Reddet"; ?></a>
                                                </li>
                                                <li>
                            ...
                            <?php if (count($products) > 0): ?>
                                <div class="pull-left">
                                    ...
                                    <?php if ($listType == 'edited_products'): ?>
                                        <button class="btn btn-sm btn-success btn-table-delete" onclick="approveSelectedEditedProducts('<?= "Bu işlemi onaylıyor musunuz?"; ?>');"><?= "Onayla"; ?></button>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                        </div>

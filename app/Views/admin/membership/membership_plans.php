    ...
    <div class="col-lg-7 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?= "Yeni Plan Oluştur"; ?></h3>
            </div>
            <form action="<?= base_url('Membership/addPlanPost'); ?>" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-inline option-plan-type m-b-15">
                        <label class="control-label m-b-5"><?= "İlan Sayısı"; ?></label>
                        <div>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label for="checkbox_is_unlimited_number_of_ads" class="custom-control-label"><?= "Sınırsız"; ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-inline m-b-15">
                        <label class="control-label m-b-5"><?= "Süre" . " (" . "Plan için zaman sınırı" . ")"; ?></label>
                        <div>
                            <div class="form-group form-group-duration">
                                <input type="number" class="form-control form-input m-r-10" name="number_of_days" min="1" max="999999999" placeholder="<?= "Gün Sayısı" ?>&nbsp;&nbsp;(E.g: 30)" required style="width: 400px; max-width: 100%;">
                            </div>
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" name="is_unlimited_time" id="checkbox_is_unlimited_time" value="1" class="custom-control-input">
                                    <label for="checkbox_is_unlimited_time" class="custom-control-label"><?= "Sınırsız"; ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-inline m-b-15">
                        <label class="control-label m-b-5"><?= "Fiyat"; ?></label>
                        <div>
                            <div class="form-group form-group-price">
                                <div class="input-group" style="width: 410px; max-width: 100%; padding-right: 10px;">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label for="checkbox_free" class="custom-control-label"><?= "Ücretsiz"; ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="plan_order" min="1" max="99999" placeholder="<?= "Sipariş"; ?>" required>
                    </div>
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="is_popular" id="checkbox_is_popular" value="1" class="custom-control-input">
                            <label for="checkbox_is_popular" class="custom-control-label"><?= "Popüler"; ?></label>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="box box-primary">
            ...
            <form action="<?= base_url('Membership/settingsPost'); ?>" method="post">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label><?= "Durum"; ?></label>
                        <?= formRadio('membership_plans_system', 1, 0, "Etkin", "Devre Dışı", $generalSettings->membership_plans_system); ?>
                    </div>
                    <div class="form-group">
                        <label><?= "Ücretsiz Planı Birden Fazla Kez Kullanmaya İzin Ver"; ?></label>
                        <?= formRadio('allow_free_plan_multiple_times', 1, 0, "Evet", "Hayır", $generalSettings->allow_free_plan_multiple_times); ?>
                    </div>
                </div>
                <div class="box-footer">
...
<?php if (!empty($membershipPlans)): ?>
    <div class="row" style="margin-bottom: 100px;">
        <div class="col-sm-12 m-b-15">
            <h3 class="box-title" style="font-size: 18px; font-weight: 600;"><?= "Üyelik Planları"; ?></h3>
        </div>
        <div class="col-sm-12">
                ...
                <?php foreach ($membershipPlans as $plan): ?>
                    <div class="price-box">
                        <?php if ($plan->is_popular == 1): ?>
                            <div class="ribbon ribbon-top-right"><span><?= "Popüler"; ?></span></div>
                        <?php endif; ?>
                        <div class="price-box-inner">
                            ...
                            <div class="text-center">
                                <div class="btn-group">
                                    <a href="<?= adminUrl('edit-plan/' . $plan->id); ?>" class="btn btn-default btn-edit"><?= "Düzenle"; ?></a>
                                    <a href="javascript:void(0)" class="btn btn-default btn-delete" onclick="deleteItem('Membership/deletePlanPost','<?= $plan->id; ?>','<?= "Bu kaydı silmek istediğinizden emin misiniz?"; ?>');"><i class="fa fa-trash-o"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    function addMembershipFeature() {
        ...
        feature += '<p class="m-b-5"><?= "Özellik"; ?><span class="btn btn-xs btn-danger btn-delete-membership-feature m-l-5"><i class="fa fa-times"></i></span></p>\n';
        <?php foreach ($activeLanguages as $language): ?>

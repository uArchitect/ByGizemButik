    ...
    <div class="col-lg-7 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?= "Planı Düzenle"; ?></h3>
            </div>
            <form action="<?= base_url('Membership/editPlanPost'); ?>" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-inline m-b-15">
                        ...
                        <div>
                            <div class="form-group form-group-duration" <?= $plan->is_unlimited_time == 1 ? 'style="display:none;"' : ''; ?>>
                                <input type="number" name="number_of_days" value="<?= !empty($plan->number_of_days) ? $plan->number_of_days : ''; ?>" class="form-control form-input m-r-10" min="1" max="999999999" placeholder="<?= "Gün Sayısı"; ?>&nbsp;&nbsp;(E.g: 30)" <?= empty($plan->is_unlimited_time) ? 'required' : ''; ?> style="min-width: 400px; max-width: 100%;">
                            </div>
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="plan_order" value="<?= $plan->plan_order; ?>" min="1" max="99999" placeholder="<?= "Sipariş"; ?>" required>
                    </div>
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                ...
                <div class="box-footer">
                    <a href="<?= adminUrl('membership-plans'); ?>" class="btn btn-danger pull-left"><?= "Geri"; ?></a>

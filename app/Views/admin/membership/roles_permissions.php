<div class="box">
    <div class="box-header with-border">
        <div class="left">
            <h3 class="box-title"><?= "Roller ve İzinler"; ?></h3>
        </div>
        <div class="right">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($item->permissions == "all"): ?>
                                            <label class="label label-success"><?= "Tüm İzinler"; ?></label>
                                        <?php endif;
                                    ...
                                    <td style="width: 180px;">
                                        <?php if ($item->is_default == 1): ?>
                                            <a href="<?= adminUrl('edit-role/' . $item->id); ?>" class="btn btn-sm btn-default btn-edit"><i class="fa fa-edit"></i>&nbsp;&nbsp;<?= "Düzenle"; ?></a>
                                        <?php else: ?>
                                            <div class="btn-group btn-group-option">
                                                <a href="<?= adminUrl('edit-role/' . $item->id); ?>" class="btn btn-sm btn-default btn-edit"><i class="fa fa-edit"></i>&nbsp;&nbsp;<?= "Düzenle"; ?></a>
                                                <a href="javascript:void(0)" class="btn btn-sm btn-default btn-delete" onclick='deleteItem("Membership/deleteRolePost","<?= $item->id; ?>","<?= "Bu kaydı silmek istediğinizden emin misiniz?"; ?>");'><i class="fa fa-trash-o"></i></a>
                                            </div>
                                        <?php endif; ?>
                                    </td>
                                </tr>

    ...
    <div class="col-sm-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="left">
                    <h3 class="box-title"><strong><?= "Talep"; ?>:&nbsp;#<?= $ticket->id; ?></strong></h3>
                </div>
                <div class="right">
                    <a href="<?= adminUrl('support-tickets'); ?>" class="btn btn-success btn-add-new">
                        <i class="fa fa-list-ul"></i>&nbsp;&nbsp;<?= "Destek Talepleri"; ?>
                    </a>
                </div>
            </div>
            <div class="box-body">
                    ...
                    <div class="ticket-container">
                        <div class="new-ticket-content new-ticket-content-reply">
                            <div class="ticket-header">
                                <p><strong><?= "Konu"; ?>:&nbsp;<?= esc($ticket->subject); ?></strong></p>
                                ...
                                <div class="col-sm-12">
                                    <div class="ticket-buttons">
                                        ...
                                        <div class="dropdown pull-right">
                                            <button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown"><?= "Durum"; ?>&nbsp;&nbsp;<span class="caret"></span></button>
                                            <ul class="dropdown-menu">
                                                <li><a href="javascript:void(0)" onclick="changeTicketStatus(<?= $ticket->id; ?>,1);"><?= "Açık"; ?></a></li>
                                                <li><a href="javascript:void(0)" onclick="changeTicketStatus(<?= $ticket->id; ?>,2);"><?= "Yanıtlandı"; ?></a></li>
                                                <li><a href="javascript:void(0)" onclick="changeTicketStatus(<?= $ticket->id; ?>,3);"><?= "Kapatıldı"; ?></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>

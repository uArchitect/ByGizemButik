        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="file-manager-footer">
                    <button type="button" id="btn_file_manager_delete" class="btn btn-sm btn-danger color-white pull-left btn-file-delete"><i class="fa fa-trash"></i>&nbsp;&nbsp;<?= "Sil"; ?></button>
                    <button type="button" id="btn_file_manager_select" class="btn btn-sm btn-success color-white btn-file-select"><i class="fa fa-check"></i>&nbsp;&nbsp;<?= "Resmi Seç"; ?></button>
                    <button type="button" class="btn btn-sm btn-default color-white" data-dismiss="modal"><?= "Kapat"; ?></button>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/html" id="files-template-file-manager">
    <li class="media">
        ...
        <div class="media-body">
            <div class="progress">
                <div class="dm-progress-waiting"><?= "Bekleniyor"; ?></div>

    ...
    <div class="box-header with-border">
        ...
        <div class="right">
            <a href="<?= adminUrl('add-city'); ?>" class="btn btn-success btn-add-new">
                <i class="fa fa-plus"></i>&nbsp;&nbsp;<?= "Şehir Ekle"; ?>
            </a>
        </div>
    </div>
    <div class="box-body">
                                    ...
                                    <td width="20%">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu options-dropdown">
                                                <li><a href="<?= adminUrl('edit-city/' . $item->id); ?>"><i class="fa fa-edit option-icon"></i><?= "Düzenle"; ?></a></li>
                                                <li><a href="javascript:void(0)" onclick="deleteItem('Admin/deleteCityPost','<?= $item->id; ?>','<?= "Bu kaydı silmek istediğinizden emin misiniz?"; ?>');"><i class="fa fa-trash option-icon"></i><?= "Sil"; ?></a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>

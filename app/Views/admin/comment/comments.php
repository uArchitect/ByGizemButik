        ...
        <div class="row">
            <div class="col-sm-12">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    <?php if ($item->status != 1): ?>
                                                        <li>
                                                            <button type="submit"><i class="fa fa-check option-icon"></i><?= "Onayla"; ?></button>
                                                        </li>
                                                    <?php endif; ?>
                                                    <li><a href="javascript:void(0)" onclick="deleteItem('Product/deleteCommentPost','<?= $item->id; ?>','Bu yorumu silmek istediğinizden emin misiniz?');"><i class="fa fa-trash option-icon"></i><?= "Sil"; ?></a></li>
                                                </ul>
                                            </div>
                                        </form>
                                    </td>
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="pull-left">
                            <button class="btn btn-sm btn-danger btn-table-delete" onclick="deleteSelectedComments('Seçili yorumları silmek istediğinizden emin misiniz?');"><?= "Sil"; ?></button>
                            <?php if ($showApproveButton == true): ?>
                                <button class="btn btn-sm btn-success btn-table-delete" onclick="approveSelectedComments();"><?= "Onayla"; ?></button>
                            <?php endif; ?>
                        </div>

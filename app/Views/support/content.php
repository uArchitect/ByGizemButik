                    ...
                    <div class="row">
                        <div class="col-md-3 hide-mobile">
                            <div class="all-help-topics">
                                <a href="<?= generateUrl('help_center'); ?>"><i class="icon-angle-left"></i>&nbsp;<?= "Tüm Yardım Konuları"; ?></a>
                            </div>
                        ...
                        <div class="col-sm-12 col-lg-9">
                            ...
                            <div class="need-more-help need-more-help-article">
                                <h3 class="title"><?= "Hala Sorularınız mı Var?"; ?></h3>
                                <span class="text-muted"><?= "Cevabınızı bulamadıysanız bizimle iletişime geçebilirsiniz"; ?></span>

                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-lg-3 m-t-15-mobile">
                                            <?php if ($quoteRequest->status != 'new_quote_request' && $quoteRequest->price_offered != 0): ?>
                                                <div class="m-b-5"><?= "Satıcı Teklifi"; ?>:&nbsp;<strong><?= priceFormatted(@convertCurrencyByExchangeRate($quoteRequest->price_offered, $selectedCurrency->exchange_rate), $selectedCurrency->code); ?></strong></div>
                                            <?php endif; ?>
